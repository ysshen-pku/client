...
public class WeaponController : MonoBehaviour
    {
     ...
     //   public Light faceLight;								// Duh
        ...
        void SkillShoot()
        {
            ...
            GameObject mbomb = Instantiate(bomb, transform.position, transform.rotation);

            mbomb.GetComponent<Rigidbody>().velocity = transform.TransformDirection(Vector3.forward * 10);
